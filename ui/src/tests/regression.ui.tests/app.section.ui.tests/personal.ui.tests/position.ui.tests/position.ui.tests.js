...
const data = require('./position.data');

const bef = () => decorate.befAft.before.beforePosition();
...
const other = () => {
    ...
    const deleteDataStaffPosition  = () => describe('Удаление данных для тестирования подраздела Должности', () => {
        ...
        decorate.db.deleteUser({
            lastName: params.db.staff.staff1.last_name,
            name: params.db.staff.staff1.first_name,
            middleName: params.db.staff.staff1.middle_name,
        });
