...
const data = require('./staff.data');
const url = require('../../../../../dictionaries/url');

const befActive = () => decorate.befAft.before.beforeStaffActive();
const befDismissed = () => decorate.befAft.before.beforeStaffDismissed();
const befPass = () => decorate.befAft.before.beforeStaffPass();
        ...
        describe('Проверка и удаление', () => {
            ...
            describe('Удаление сотруднкиа из БД', () => {
                ...
                decorate.db.deleteUser({
                    lastName: data.staff.staff1.lastName,
                    name: data.staff.staff1.firstName,
                    middleName: ''
                });
        ...
        describe('Проверка сотрудника и удаление', () => {
            ...
            describe('Удаление сотруднкиа из БД', () => {
                ...
                decorate.db.deleteUser({
                    lastName: data.staff.staff1.lastName,
                    name: data.staff.staff1.firstName,
                    middleName: data.staff.staff1.middleName
                });
                decorate.db.truncateUserCar();
                decorate.db.truncateUserBarcode();
                decorate.page.base.loading({
...
const other = () => {
    ...
    const deleteDataStaffFilter = () => describe('Удаление данных для тестирвоания фильтров подразделов: ' +
        ...
        decorate.db.truncateUserVisitor();
        decorate.db.deleteUser({
            lastName: params.staff.staff1.lastName,
            name: params.staff.staff1.firstName,
            middleName: params.staff.staff1.middleName
        });
        decorate.db.deleteUser({
            lastName: params.staff.staff2.lastName,
            name: params.staff.staff2.firstName,
            middleName: params.staff.staff2.middleName
        });
        decorate.db.truncateUserCar();
        decorate.db.truncateUserBarcode();
        decorate.page.base.loading({
    ...
    const addDataStaff = () => describe('Добавление данных для тестирования подразделов Персонал/Сотрудники, ' +
        ...
        describe('Добавление дополнительных данных', () => {
            decorate.api.addAdditionalData({
    ...
    const deleteDataStaff = () => describe('Удаление данных для тестирования подразделов Персонал/Сотрудники, ' +
        ...
        describe('Удаление дополнительных данных', () => {
            decorate.db.deleteAdditionalData({
...
module.exports = {
    test: test('active', 'Персонал / Сотрудники - вкладка - Действующие.'),
    testPass: test('pass', 'Бюро пропусков / Сотрудники.'),
    other: other()
}