...
const data = require('./schedule.data');

const bef = () => decorate.befAft.before.beforeSchedule();
...
const other = () => {
    ...
    const addSearchFilterData = () => describe('Добавление графиков работы для тестирования фильтра "Поиск..."', () => {
        bef();
        aft();
        decorate.api.addSchedule(data.weekly1.db);
        decorate.api.addSchedule(data.weekly2.db);
    });

    const deleteSearchFilterData = () => describe('Удаление графиков работы для тестирования фильтра "Поиск..."',() => {
    ...
    const addStaffData = () => describe('Добавление данных для тестирования удаления используемого графика ' +
        'работы сотрудником', () => {
        bef();
        aft();
        decorate.api.addSchedule(data.weekly1.db);
    ...
    const deleteStaffData = () => describe('Удаление данных для тестирования удаления используемого графика ' +
        'работы сотрудником', () => {
        decorate.db.deleteSchedule({
            name: data.weekly1.name
        });
