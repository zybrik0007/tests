...
class WorkedJournalPage extends BasePage {
    ...
    async tableStrHandler(str, timeout) {
        const handler = await this.xpathHandler('//app-wj-detail-information' + elements.tableStrNum(str),
    ...
    async tableCellGetText(head, str, cell, timeout) {
        ...
        return await this.xpathGetText('//app-wj-detail-information' + elements.tableCellText(str, cell),
    ...
    async tableHeadElement(head, cell, timeout) {
        const headText = await this.xpathGetText('//app-wj-detail-information' + elements.tableHeadText(cell),
