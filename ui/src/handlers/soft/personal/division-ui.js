...
const add = () => {
    ...
    const addMaxParams = () => describe('Подразделение. Добавление. Добавление подраздления 1 уровня и подразделения ' +
    ...
    const addIncludeProgression =() => describe('Подразделение. Добавление. Добавление 5 подразделений 1 уровня ' +
        'с вложенннными подразделениямми ' + 'прогрессией до 5.', () => {
...
const print = () => {
    ...
    const printMaxParams = () => describe('Подразделение. Печать. Проверка печати 5 подразделений 1 уровня ' +
        'с вложенннными подразделениями прогрессией до 5 с заполненными параметрами "Телефон" и "Описание"', () => {
