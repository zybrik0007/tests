...
const other = () => {
    ...
    const display = () => describe(`Котроль доступа / Журнал верификации. Общая проверка без данных.`,
        () => {
    ...
    const checkData = () => describe(`Котроль доступа / Журнал верификации. Проверка отображения данных .`, () => {
    ...
    const filterUser = () => describe(`Котроль доступа / Журнал верификации. Проверка фильтра по пользователям.`,
        () => {
    ...
    const filterSearch = () => describe(`Котроль доступа / Журнал верификации. Проверка фильтра по поиску.`, () => {
    ...
    const filterDate = () => describe(`Котроль доступа / Журнал верификации. Проверка фильтра по дате.`, () => {
    ...
    const printTable = () => describe(`Котроль доступа / Журнал верификации. Проверка печати.`, () => {
    ...
    const exportXLSX = () => describe(`Котроль доступа / Журнал верификации. Экспорт XLSX.`, () => {
    ...
    const exportCSV = () => describe(`Котроль доступа / Журнал верификации. Экспорт CSV.`, () => {
        const params = {
    ...
    const updateData = () => describe('Котроль доступа / Журнал верификации. Проверка кнопки Обновить данные', () => {
