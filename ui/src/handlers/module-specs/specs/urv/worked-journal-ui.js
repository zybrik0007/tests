...
const other = () => {
    ...
    const checkCalculationWorkedJournal = () => describe('УРВ. Журнал отработанного времени. ' +
        ...
        describe('Проверка расчетов в общей таблицы у всех сотрудников', () => {
            ...
            describe('Проверка строки 6', () => {
                ...
                decorate.el.table.cellGetText({
                    ...
                    strNumber: 6,
                    cellNumber: 16,
                    value: data.schedules.schedule6.name,
                    timeout: entry.max
                });
            });
            ...
            describe('Проверка строки 7', () => {
                ...
                decorate.el.table.cellGetText({
                    ...
                    strNumber: 7,
                    cellNumber: 16,
                    value: data.schedules.schedule7.name,
                    timeout: entry.max
                });
            });
            ...
            describe('Проверка строки 8', () => {
                ...
                decorate.el.table.cellGetText({
                    ...
                    strNumber: 8,
                    cellNumber: 16,
                    value: data.schedules.schedule8.name,
                    timeout: entry.max
                });
            });
        });
        ...
        describe(`Проверка расчетов по дням у сотрудника "${data.fio.staff3}"`, () => {
            describe('Открытие расчетов по дням', () => {
                decorate.page.base.loading({
                    timeout: entry.sleep2
                });
        ...
        describe(`Проверка расчетов по дням у сотрудника "${data.fio.staff6}"`, () => {
            describe('Открытие расчетов по дням', () => {
                decorate.el.table.strHandler({
                    strNumber: 6,
                    timeout: entry.max
        ...
        describe(`Проверка расчетов по дням у сотрудника "${data.fio.staff7}"`, () => {
            describe('Открытие расчетов по дням', () => {
                decorate.el.table.strHandler({
                    strNumber: 7,
                    timeout: entry.max
        ...
        describe(`Проверка расчетов по дням у сотрудника "${data.fio.staff8}"`, () => {
            describe('Открытие расчетов по дням', () => {
                decorate.el.table.strHandler({
                    strNumber: 8,
                    timeout: entry.max
    ...
    const documentCalculationWorkedJournal = () => describe('УРВ. Журнал отработанного времени. ' +
        'Добавление оправдтаельных документов и перересчет .', () => {
        ...
        describe(`Добавлние оправдательных документов сотруднику "${data.fio.staff5}" `, () => {
