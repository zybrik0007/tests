    ...
    const checkCalculationReports = () => describe('УРВ. Отчёт УРВ. Проверка таблицы и расчетов', () => {
        ...
        const arrayStr = [
            ...
            [
                ...
                '24:00', '00:00', '24:00', '00:00', '24:00',
                '00:00', '24:00', '00:00', '23:58', '00:00',
                '24:00', '00:00', '24:00', '00:00', '24:00',
                '00:00', '24:00', '00:00', '00:00', '00:00',
                '00:00', '00:00', '00:00', '00:00', '00:00',
                '00:00', '00:00', '00:00', '00:00', '215:58',
                '00:00', '00:00', '-144:02', '167:58', '167:58',
                '48:00', '48:00', '215:58', '215:58', '18:00',
                '00:02', '00:02', '00:02', '00:00'
            ],
            [
            ...
            [
                ...
                '00:00', '00:00', '-336:00', '15:00', '15:00',
                '00:00', '00:00', '15:00', '15:00', '01:00',
                '00:00', '00:00', '00:00', '00:00'
            ],
            [
            ...
            const params = {
                ...
                json: [
                    ...
                    },
                    {
                        ...
                        'пятница, 02-06-2023': '24:00',
                        'суббота, 03-06-2023': '00:00',
                        'воскресенье, 04-06-2023': '24:00',
                        'понедельник, 05-06-2023': '00:00',
                        'вторник, 06-06-2023': '24:00',
                        'среда, 07-06-2023': '00:00',
                        'четверг, 08-06-2023': '24:00',
                        'пятница, 09-06-2023': '00:00',
                        'суббота, 10-06-2023': '23:58',
                        'воскресенье, 11-06-2023': '00:00',
                        'понедельник, 12-06-2023': '24:00',
                        'вторник, 13-06-2023': '00:00',
                        'среда, 14-06-2023': '24:00',
                        'четверг, 15-06-2023': '00:00',
                        'пятница, 16-06-2023': '24:00',
                        'суббота, 17-06-2023': '00:00',
                        'воскресенье, 18-06-2023': '24:00',
                        'понедельник, 19-06-2023': '00:00',
                        'вторник, 20-06-2023': '00:00',
                        'среда, 21-06-2023': '00:00',
                        'четверг, 22-06-2023': '00:00',
                        ...
                        'четверг, 29-06-2023': '00:00',
                        'пятница, 30-06-2023': '00:00',
                        'Рабочее время': '215:58',
                        'Баланс отработанного времени': '-144:02',
