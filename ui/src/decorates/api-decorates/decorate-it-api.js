...
module.exports = {
    ...
    addDeviceInRoom: (obj) => it(`Добавление устройства IP: "${obj.device}" в помещение "${obj.room}".`, async () => {
            const cook = await page.base.getCookie('token');
    ...
    addSchedule: (obj) => it(`Добавление графика работы "${obj.name}".`, async () => {
        const cook = await page.base.getCookie('token');
    ...
    addStaff: (obj) => it(`Добавление сотрудника "${obj.last_name} ${obj.first_name}".`, async () => {
        const cook = await page.base.getCookie('token');
    ...
    addVisitor: (obj) => it(`Добавление посетителя "${obj.last_name} ${obj.first_name}".`, async () => {
        const cook = await page.base.getCookie('token');
